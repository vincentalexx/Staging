...
class FillPermissionsForDiscipleshipDetail extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDiscipleshipDetail constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.discipleship-detail',
            'admin.discipleship-detail.index',
            'admin.discipleship-detail.index-smp',
            'admin.discipleship-detail.index-sma',
            'admin.discipleship-detail.index-pemuda',
            'admin.discipleship-detail.create',
            'admin.discipleship-detail.show',
            'admin.discipleship-detail.edit',
