...
class FillPermissionsForCongregation extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.congregation',
            'admin.congregation.index',
            'admin.congregation.create',
            'admin.congregation.show',
            'admin.congregation.edit',
            'admin.congregation.delete',
            'admin.congregation.bulk-delete',
        ]);
