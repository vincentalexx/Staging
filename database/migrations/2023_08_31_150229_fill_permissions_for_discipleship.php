...
class FillPermissionsForDiscipleship extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDiscipleship constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.discipleship',
            'admin.discipleship.index',
            'admin.discipleship.create',
            'admin.discipleship.show',
            'admin.discipleship.edit',
            'admin.discipleship.delete',
            'admin.discipleship.bulk-delete',
        ]);
